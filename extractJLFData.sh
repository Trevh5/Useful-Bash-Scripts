...
dir="/Users/huff6/Desktop/TransferDat/dehydration/processed/nifti" 

# Where you want you .csv file saved.
dataLocation="/Users/huff6/Desktop/TransferDat/dehydration/processed/data" 
...
#########################################################################
output="$(c3d ${subjDir}/brain2.nii.gz ${subjDir}/labels2/Labels.nii.gz -label-statistics)" 
#########################################################################
